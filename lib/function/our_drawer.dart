            ...
            child: Obx(
              () => DrawerHeader(
                ...
                child: UserAccountsDrawerHeader(
                  ...
                  currentAccountPicture: CircleAvatar(backgroundColor: Colors.amberAccent, child: Text(idKaryawan.value, style: TextStyle(fontSize: 12))),
                ),
              ),
            ),
          ),
              ...
              child: ListView(
                ...
                children: [
                  ...
                  ListTile(
                    ...
                    title: const Text('Komisi Terapis', style: TextStyle(fontFamily: 'Poppins')),
                    onTap: () {
