...
class _TransaksiMassageState extends State<TransaksiMassage> {
  ...
  Future<void> _getGRO() async {
    try {
      ...
      setState(() {
        _listGRO =
            (response.data as List).map((el) {
              return {"id_karyawan": el['id_karyawan'], "nama_karyawan": el['nama_karyawan'], "umur": el['umur'], "jabatan": el['jabatan']};
            }).toList();
      });
    } catch (e) {
  ...
  Future<void> _fetchHistoryMember(String id_member) async {
    try {
      final response = await dio.get('${myIpAddr()}/history/historymemberkunjungan/$id_member'); // API request
      if (response.statusCode == 200) {
        setState(() {
          historyMember = response.data;
        });
      } else {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Error fetching ID: ${response.statusCode}")));
      }
    } catch (e) {
  ...
  Future<void> _checkMemberPromos(String id_member) async {
    ...
    try {
      ...
      CherryToast.error(
        title: Text("Failed to load member promos.", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontFamily: 'Poppins')),
                  ...
                  GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return InkWell(
                          ...
                          if (data['status'] == "maintenance" || data['status'] == "occupied") {
                            ...
                            setState(() {
                              try {
                                ...
                                print("Error: txtRoom is not directly accessible here. Ensure it's properly managed by GetX.");
                              }
                            });
                            Get.back();
                          }
                        ...
                        child: Container(
                          decoration: BoxDecoration(color: roomColor, borderRadius: BorderRadius.circular(20)),
                          child: Column(
                        ...
                        if (isOccupied) {
                          ...
                          setState(() {
                            try {
                              ...
                              print("Error: txtTerapis is not directly accessible here. Ensure it's properly managed by GetX.");
                            }
                          });
                          Get.back();
                        }
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [SizedBox(height: 10), Text(data['nama_karyawan'], style: TextStyle(fontSize: 30, fontFamily: 'Poppins'))],
                                ),
                              ),
                            ],
                          ),
              ...
              child: GridView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return InkWell(
                    ...
                    child: Container(
                      margin: const EdgeInsets.only(top: 20),
                      decoration: BoxDecoration(borderRadius: BorderRadius.circular(20), color: const Color.fromARGB(255, 35, 195, 144)),
                      child: Center(
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.start,
                          children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        ...
                        child: Column(
                          children: [
                            Row(
                              children: [
                                Text('No Transaksi :', style: TextStyle(fontSize: 18, fontFamily: 'Poppins')),
                                Padding(
                            ...
                            Row(
                              children: [
                                Padding(padding: EdgeInsets.only(top: 15), child: Text('No Locker :', style: TextStyle(fontSize: 18, fontFamily: 'Poppins'))),
                                Padding(
                            ...
                            Row(
                              children: [
                                Padding(padding: EdgeInsets.only(top: 15), child: Text('Jenis Tamu :', style: TextStyle(fontSize: 18, fontFamily: 'Poppins'))),
                                Padding(
                            ...
                            Row(
                              children: [
                                Padding(padding: EdgeInsets.only(top: 15), child: Text('No HP :', style: TextStyle(fontSize: 18, fontFamily: 'Poppins'))),
                                Padding(
                            ...
                            Row(
                              children: [
                                Padding(padding: EdgeInsets.only(top: 15), child: Text('Nama :', style: TextStyle(fontSize: 18, fontFamily: 'Poppins'))),
                                Padding(
                            ...
                            Row(
                              children: [
                                Padding(
                                  ...
                                  child: Text('Jenis Pilihan :', style: TextStyle(fontSize: 18, fontFamily: 'Poppins')),
                                ),
                                Row(
                                  children: [
                                    Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: DropdownButton<String>(
                                          ...
                                          items:
                                              listJenisPilihan.map<DropdownMenuItem<String>>((String value) {
                                                return DropdownMenuItem<String>(
                                                  value: value,
                                                  child: Align(
                                                    alignment: Alignment.centerLeft,
                                              ...
                                              child: Container(
                                                ...
                                                child: TextButton(
                                                  onPressed: () {
                                                    ...
                                                    CherryToast.success(title: Text('Notif berhasil dikirim')).show(context);
                                                    isbuttonvisible.value = false;
                                                    controllerPekerja.statusshowing.value = 'pressed';
                                                  },
                                                  style: TextButton.styleFrom(foregroundColor: Colors.black),
                                                  child: Text('SEND NOTIF', style: TextStyle(fontSize: 18, fontFamily: 'Poppins')),
                                                ),
                                              ),
                                            )
                                            : SizedBox.shrink();
                            ...
                            Row(
                              children: [
                                Padding(padding: EdgeInsets.only(top: 15), child: Text('Terapis :', style: TextStyle(fontSize: 18, fontFamily: 'Poppins'))),
                                Row(
                                  children: [
                                    Padding(
                                    ...
                                    Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: TextButton(
                                          ...
                                          style: TextButton.styleFrom(foregroundColor: Colors.black),
                                          child: Text('THERAPIST', style: TextStyle(fontSize: 18, fontFamily: 'Poppins')),
                                        ),
                                      ),
                                    ),
                                  ],
                            ...
                            Row(
                              children: [
                                Padding(padding: EdgeInsets.only(top: 15), child: Text('Room :', style: TextStyle(fontSize: 18, fontFamily: 'Poppins'))),
                                Row(
                                  children: [
                                    Padding(
                                    ...
                                    Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: TextButton(
                                          ...
                                          style: TextButton.styleFrom(foregroundColor: Colors.black),
                                          child: Text('ROOM', style: TextStyle(fontSize: 18, fontFamily: 'Poppins')),
                                        ),
                                      ),
                                    ),
                                  ],
                            ...
                            Row(
                              children: [
                                Padding(padding: EdgeInsets.only(top: 15), child: Text('GRO :', style: TextStyle(fontSize: 18, fontFamily: 'Poppins'))),
                                Row(
                                  children: [
                                    Padding(
                                    ...
                                    Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: TextButton(
                                          ...
                                          style: TextButton.styleFrom(foregroundColor: Colors.black),
                                          child: Text('GRO', style: TextStyle(fontSize: 18, fontFamily: 'Poppins')),
                                        ),
                                      ),
                                    ),
                                  ],
                      ...
                      Column(
                        ...
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Align(alignment: Alignment.topLeft, child: Text('Detail Member :', style: TextStyle(fontSize: 18, fontFamily: 'Poppins'))),
                          Padding(
                            ...
                            child: Container(
                              ...
                              child:
                                  historyMember.isEmpty
                                      ? Center(child: Text("Silahkan Scan QR Terlebih Dahulu", style: TextStyle(fontFamily: 'Poppins')))
                                      : ListView.builder(
                                              ...
                                              Padding(
                                                ...
                                                child: Column(
                                                  children: [
                                                    Row(
                                                      children: [
                                                        Container(
                                                          width: 100,
                                                          height: 25,
                                                          child: Text('Nama Promo', style: TextStyle(fontFamily: 'Poppins', fontSize: 14)),
                                                        ),
                                                        SizedBox(width: 70),
                                                        Container(
                                                          width: 120,
                                                          height: 25,
                                                          child: Text('Sisa Kunjungan', style: TextStyle(fontFamily: 'Poppins', fontSize: 14)),
                                                        ),
                                                        SizedBox(width: 24),
                                                        Container(
                                                          width: 130,
                                                          height: 25,
                                                          child: Text('Berlaku Sampai', style: TextStyle(fontFamily: 'Poppins', fontSize: 14)),
                                                        ),
                                                      ],
                                                    ),
                                                    ...
                                                    Row(
                                                      children: [
                                                        Container(width: 160, child: Text(item['nama_promo'] ?? '', style: TextStyle(fontFamily: 'Poppins'))),
                                                        SizedBox(width: 25, child: Text("|", textAlign: TextAlign.left, style: TextStyle(fontSize: 21))),
                                                        Container(
                                                          width: 90,
                                                          child: Text(
                                                        ...
                                                        SizedBox(width: 55, child: Text("|", textAlign: TextAlign.center, style: TextStyle(fontSize: 21))),
                                                        Container(
                                                          width: 90,
                                                          child: Text(
                                                            item['exp_kunjungan'] != null && item['exp_kunjungan'] != '' ? '${item['exp_kunjungan']}' : '',
                                                            style: TextStyle(fontFamily: 'Poppins'),
                                                          ),
                                                        ),
                                                      ],
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: TextButton(
                            ...
                            style: TextButton.styleFrom(foregroundColor: Colors.black),
                            child: Text('Daftar Member', style: TextStyle(fontSize: 40, fontFamily: 'Poppins')),
                          ),
                        ),
                      ],
                    ),
