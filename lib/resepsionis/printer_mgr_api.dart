...
class PrinterHelper {
  ...
  static List<int> _printTotals(
    ...
    bytes += generator.row([
      ...
      PosColumn(
        text: '-${formatter.format(finalNominalDisc)}',
        width: 6,
        styles: const PosStyles(align: PosAlign.right),
      ), // Use rounded value
    ]);
