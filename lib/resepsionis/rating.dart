...
class RatingController extends GetxController {
  ...
  var selectedRatings = {"pelayanan_terapis": RxnInt(null), "fasilitas": RxnInt(null), "pelayanan_keseluruhan": RxnInt(null)};
            ...
            Padding(
              ...
              child: Obx(() {
                if (c.isFirstTimeRate.value) {
                  return Text('Berikan Rating Anda 🤗', style: TextStyle(fontFamily: 'Poppins', fontSize: 20, fontWeight: FontWeight.bold));
                } else {
                  return Text('Rating pada ${c.idTransaksi} Adalah: ', style: TextStyle(fontFamily: 'Poppins', fontSize: 20, fontWeight: FontWeight.bold));
                }
              }),
            ),
            SizedBox(height: 20),
    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: Text(category, style: TextStyle(fontFamily: 'Poppins', fontSize: 20, fontWeight: FontWeight.bold)),
        ),
        SizedBox(height: 10),
        Padding(
