...
class SupplierController extends GetxController {
  ...
  Future<void> deleteItem(int id) async {
    try {
      ...
      CherryToast.success(
        title: const Text("Sukses Menghapus Item"),
      ).show(Get.context!);
      ...
      CherryToast.error(
        title: const Text("Gagal Menghapus Item"),
      ).show(Get.context!);
  ...
  void _showEditPriceDialog(BuildContext context, Map<String, dynamic> detail) {
    ...
    RxString selectedUnit =
        "${detail['satuan'] ?? masterSatuan.firstOrNull}".obs;
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              try {
                ...
                CherryToast.success(
                  title: const Text("Harga diupdate"),
                ).show(Get.context!);
  ...
  Future<bool> _confirmDeletePricePerItem(
    BuildContext context,
    Map<String, dynamic> item,
  ) async {
    final res = await Get.dialog<bool>(
...
class ListSupplierPage extends StatelessWidget {
                        ...
                        return Theme(
                          data: Theme.of(context).copyWith(
                            dividerColor: const Color(
                              0xFFBCAAA4,
                            ), // Color for dividers inside ExpansionTile
                          ),
                          child: ListView.separated(
                            ...
                            itemBuilder: (_, i) {
                              final item = data[i];
                              final List details =
                                  item['detail_supplier_information'] ?? [];
                              ...
                              return Card(
                                ...
                                child: ExpansionTile(
                                  ...
                                  trailing: IconButton(
                                    ...
                                    onPressed:
                                        () =>
                                            c._confirmDeleteItem(context, item),
                                  ),
  ...
  void _showAddItemDialog(BuildContext context, String idSupplier) {
    final defaultUnit =
        (c.masterSatuan.isNotEmpty ? c.masterSatuan.first : null);
                        ...
                        children: [
                          ...
                          Expanded(
                            ...
                            child: Obx(() {
                              ...
                              rows[i]["satuanSel"] =
                                  (rows[i]["satuanSel"] as RxnString?) ??
                                  RxnString(defaultUnit);
                  ...
                  saving.value
                      ...
                      : () async {
                        ...
                        for (final r in rows) {
                          ...
                          final String? unit =
                              (r["satuanSel"] as RxnString).value;
                          final String p =
