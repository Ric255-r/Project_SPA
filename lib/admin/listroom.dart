...
class WidgetListRoomMobile extends StatefulWidget {
  const WidgetListRoomMobile({super.key});

  @override
  State<WidgetListRoomMobile> createState() => _WidgetListRoomMobileState();
}

class _WidgetListRoomMobileState extends State<WidgetListRoomMobile> {
  late final Dio dio;
