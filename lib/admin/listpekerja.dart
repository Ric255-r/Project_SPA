...
class _ListpekerjaState extends State<Listpekerja> {
  ...
  void openKontrakFile(String kontrakPath) async {
    var urlLama = myIpAddr();
    var splitUrl = urlLama.split("/");
...
class WidgetListPekerjaMobile extends StatefulWidget {
  final List<Map<String, dynamic>> filteredList;
  final TextEditingController controller;
  final Function(String) onSearch;

  const WidgetListPekerjaMobile({
    super.key,
  ...
  @override
  State<WidgetListPekerjaMobile> createState() =>
      _WidgetListPekerjaMobileState();
}
